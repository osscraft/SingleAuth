...
use Lay\Advance\Http\Response;
use Lay\Advance\Core\AbstractSingleton;
use Lay\Advance\Util\Utility;
use Lay\Advance\Util\Logger;
use Lay\Advance\Core\App;
use Lay\Advance\Core\Singleton;
use Lay\Advance\Core\Templatelizable;
use Exception;
use Iterator;
...
class Template extends Singleton implements Templatelizable
{
    ...
    {
        $filepath = $this->dir . '/theme/' . $this->theme . '/' . $filename;
        if (($path = realpath($filepath)) && is_file($filepath)) {
            $this->file = $path;
        }
    }
    /**
