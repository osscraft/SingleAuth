...
class SSOToOAuth2 {
    ...
    public $authorizeURL = 'http://sso.lixin.edu.cn/authorize.php';

    public $accessTokenURL = 'http://sso.lixin.edu.cn/token.php';

    public $logoutURL = 'http://sso.lixin.edu.cn/logout.php';
