...
$CFG['mysql_session_lifetime'] = 100;//设置memcache的过期时间
$CFG['mysql_session_delay'] = 20;//延迟写入时长,当离过期时间小于本值时更新，0为实时保持且不使用memcache缓存
$CFG['mysql_token_keep'] = true;// token保持暂无效
$CFG['mysql_token_delay'] = 60;//延迟写入时长,当离过期时间小于本值时更新令牌
...
$CFG['memcaches'][0]['host'] = '127.0.0.1';//设置某memcache服务器的地址
...
$CFG['auth_code_lifetime'] = 60;//设置验证码的过期时间
$CFG['access_token_lifetime'] = 1800;//设置access_token的过期时间
$CFG['refresh_token_lifetime'] = 2592000;//60*60*24;//设置refresh_token的过期时间
...
$CFG['frontcache']['image']['open'] = true;
//$CFG['frontcache']['css']['base'] = '';
...
// browscap dir
$CFG['browscap_cachedir'] = __DIR__ . '/php_browscap';
...
$CFG['server']['gateway']['name'] = 'Gateway';
...
$CFG['server']['business_worker']['name'] = 'BusinessWorker';
